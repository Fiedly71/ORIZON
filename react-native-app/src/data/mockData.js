...
export const propertyAmenities = [
  ...
  'Internet fibre', 'Ascenseur', 'Vue mer', 'Meublé', 'Titre clair',
...
export const servicesList = [
  { id: 's1', icon: 'home', title: 'Vente & Location', desc: 'Publiez ou trouvez un bien. Maisons, appartements, terrains, hôtels et espaces commerciaux.' },
  ...
  { id: 's3', icon: 'stats-chart', title: 'Estimation & Evaluation', desc: 'Obtenez une estimation précise de la valeur de votre propriété par nos experts certifies.' },
  ...
  { id: 's6', icon: 'trending-up', title: 'Investissement', desc: 'Portefeuille, rendement locatif, promotions immobilières. Maximisez votre patrimoine.' },
];
...
export const plans = [
  { id: 'plan-starter', name: 'Starter', priceMonthly: 25, color: '#7A8899', benefits: ['3 annonces activées', 'Messagerie illimitee', 'Statistiques de base', 'Support standard'] },
  { id: 'plan-pro', name: 'Pro', priceMonthly: 65, color: '#1A3C5E', benefits: ['20 annonces activées', 'Mise en avant hebdomadaire', 'Statistiques avancees', 'Support prioritaire', 'Badge Agent vérifie'] },
