...
async function run() {
  ...
  [
    ...
    'arrow-up-outline', 'arrow-up-circle', 'arrow-up-circle-outline',
    'apps-outline', 'apps', 'grid', 'grid-outline',
    'leaf-outline', 'leaf', 'storefront-outline', 'storefront',
    'gift-outline', 'gift', 'pricetag-outline', 'pricetag',
