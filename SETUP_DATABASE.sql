...
-- ============================================================================
-- profile_bootstrap.sql (Patch 21)
-- ============================================================================

-- Patch 21 - Bootstrap profil complet au signup (option B email non verifie).
--
-- Objectif : garantir que TOUS les champs d'inscription (nom, tÃ©lÃ©phone, rÃ´le,
-- adresse, ville, dÃ©partement, nom d'agence, code parrain, email) sont
-- persistÃ©s dans public.profiles au moment de l'inscription, MEME si l'email
-- n'est pas encore vÃ©rifiÃ©. Ainsi les donnÃ©es remontent dans Supabase et le
-- dashboard admin mÃªme en attente de vÃ©rification email.
--
-- Idempotent. Ã€ exÃ©cuter dans Supabase SQL Editor.
...
--    On upsert pour Ãªtre robuste si la ligne existe dÃ©jÃ .
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
create or replace function public.handle_new_user()
returns trigger
language plpgsql
...
-- Trigger dÃ©jÃ  crÃ©Ã© par kyc.sql; on recrÃ©e par sÃ©curitÃ© s'il manque.
drop trigger if exists on_auth_user_created on auth.users;
create trigger on_auth_user_created
  after insert on auth.users
  for each row execute procedure public.handle_new_user();
...
--    dans auth.users, on met Ã  jour profiles.email_verified.
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
--    Filet de sÃ©curitÃ© cÃ´tÃ© client. AppelÃ©e aprÃ¨s signUp, elle
--    remplit/complÃ¨te la ligne profiles Ã  partir d'un JSON. Ne
--    nÃ©cessite pas de session (utilise SECURITY DEFINER) mais
--    exige que l'user_id existe dÃ©jÃ  dans auth.users.
--    Nota : safe Ã  appeler plusieurs fois (upsert).
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
as $$
begin
  -- On vÃ©rifie que l'user_id correspond Ã  un vrai auth.users
...
--    aussi email_verified et created_at pour trier "Ã  vÃ©rifier".
--    Rien Ã  faire sur le service ici : l'app lit dÃ©jÃ  profiles.*
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- 6) Backfill : synchronise email + email_verified pour les
--    utilisateurs dÃ©jÃ  existants dans auth.users.
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
